...
export default function CardHistory({order}: ICardHistoryProps) {
  return (
    <View style={styles.container}>
      <Text style={styles.tanggal}>{order.tanggalPemesanan}</Text>
      {order.pesanans.map((history, index) => {
        return (
          <View key={index} style={styles.history}>
            ...
            <View style={styles.desc}>
              ...
              <Text style={styles.harga}>
                Rp. {numberWithCommas(String(history.product.harga))}
              </Text>
              ...
              <Text style={styles.textBold}>
                Total Harga : Rp. {numberWithCommas(String(history.totalHarga))}
              </Text>
            </View>
          </View>
        );
